...
- 원본 content: `content/news`, Publication Google Sheet, `content/photos/raw`, `src/assets/dataset/people.json`, `src/assets/images/people`
...
- `npm run publications:pull` (Google Sheet를 Publication snapshot으로 가져오기)
