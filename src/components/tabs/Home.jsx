...
function CarouselControls({ label, targetRef, onMove }) {
    return (
        <div
            ...
            <span className="home-carousel-controls__hint">
                Swipe to browse
            </span>
            <button
                type="button"
...
function Home() {
    ...
    const orderedResearchAreas = useShuffledOrder(HOME_RESEARCH_AREAS);
    const publicationSnapshot = useMemo(() => getPublicationYearSnapshot(), []);
        ...
        <>
            <section
                ...
                <div className="home-news-carousel__head">
                    <div>
                        <p className="home-news-carousel__eyebrow">
                            LATEST FROM AAIG
                        </p>
                ...
                <div className="home-news-carousel__rail-wrap">
                    <div
                        ...
                        onKeyDown={(event) =>
                            handleRailKeyDown(newsRailRef, event)
                        }>
                        {newsItems.map((item, index) => (
                            <Link
                                ...
                                <img
                                    src={
                                        NEWS_IMAGES[index % NEWS_IMAGES.length]
                                    }
                                    alt=""
            ...
            <section
                ...
                <div className="home-publication-snapshot__intro">
                    ...
                    <p>
                        A quick view of regular conference papers currently
                        listed in the AAIG archive.
                    </p>
                    <Link
                        to="/publication"
                        className="home-publication-snapshot__link">
                ...
                <div className="home-publication-snapshot__results">
                    ...
                    {publicationSnapshot.venues.length ? (
                        <ul
                            className="home-publication-snapshot__venues"
                            aria-label={`${publicationSnapshot.year} regular conference paper counts by venue`}>
                            {publicationSnapshot.venues.map(
                                ({ venue, count }) => (
                                    <li key={venue}>
                                        <span>{venue}</span>
                                        <strong>{count}</strong>
                        ...
                        <p className="home-publication-snapshot__empty">
                            New publications will appear here as they are added
                            to the archive.
                        </p>
                    )}
                </div>
            ...
            <section
                ...
                <div className="home-publication-index__intro">
                    ...
                    <div className="home-publication-index__actions">
                        <Link
                            className="home-publication-index__link"
                            to="/publication">
                            View all publications ↗
                        </Link>
                    </div>
                ...
                <div className="home-publication-index__rail-wrap">
                    <div
                        ...
                        onKeyDown={(event) =>
                            handleRailKeyDown(publicationRailRef, event)
                        }>
            ...
            <section
                ...
                <div className="home-research-index__rail-wrap">
                    <div
                        ...
                        onKeyDown={(event) =>
                            handleRailKeyDown(researchRailRef, event)
                        }>
                        {orderedResearchAreas.map((area) => (
                            <Link
                                ...
                                <div className="home-research-index__copy">
                                    <ul
                                        className="home-research-index__labs"
                                        aria-label="Participating laboratories">
                                        {area.labs.map((lab) => (
